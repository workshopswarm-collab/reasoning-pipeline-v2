...
| `/Users/agent2/.openclaw/orchestrator/scripts/predquant/canonical_artifacts.py` | `FIX-031`, `BLK-027`, `QDT-005`, `CLS-006`, `CLS-005`, `MODEL-004` | Importable deterministic fixture and validator for canonical machine-artifact scan evidence. |
