...
| `/Users/agent2/.openclaw/researcher-swarm/scripts/researcher_swarm/persistence.py` | `MIG-006`, `CLS-001` to `CLS-008`, `VER-001` to `VER-004`, `MODEL-003` | Importable compact/ref-only Session 4 persistence helpers for researcher and verification artifacts without probability, forecast, SCAE ledger, or decision authority. |
