...
| `/Users/agent2/.openclaw/orchestrator/scripts/bin/run_ads_pipeline_loop.py` | `AUTO-001` to `AUTO-005`, `MIG-013` | Orchestrator-owned runner entrypoint. AUTO-001 provides the disabled-by-default, non-executing skeleton; later AUTO rows add leases, stage execution, forecast persistence, and loop continuation. |
...
| `/Users/agent2/.openclaw/orchestrator/scripts/predquant/script_placement.py` | `FND-001`, `FND-005`, `FIX-039`, `BLK-032` | Importable parser and validator for planned runtime script ownership, missing paths, duplicate paths, and placement-map scan evidence. |
| `/Users/agent2/.openclaw/orchestrator/scripts/bin/check_ads_canonical_artifacts.py` | `FIX-031`, `BLK-027`, `QDT-005`, `CLS-006`, `CLS-005`, `MODEL-004` | Static scan for canonical machine-artifact fixtures across QDT, researcher assignment, sidecar, coverage, and model provenance contracts. |
| `/Users/agent2/.openclaw/orchestrator/scripts/bin/check_ads_non_scae_authority.py` | `BLK-001`, `CLS-002`, `SYN-001`, `DEC-001`, `PERSIST-001` | Static scan proving researcher, synthesis, decision, and forecast-decision persistence surfaces reject non-SCAE probability, fair-value, interval, and replacement-probability authority. |
| `/Users/agent2/.openclaw/orchestrator/scripts/predquant/canonical_artifacts.py` | `FIX-031`, `BLK-001`, `BLK-027`, `QDT-005`, `CLS-006`, `CLS-005`, `SYN-001`, `DEC-001`, `PERSIST-001`, `MODEL-004` | Importable deterministic fixtures and validators for canonical machine-artifact and non-SCAE probability-authority scan evidence. |
| `/Users/agent2/.openclaw/orchestrator/scripts/bin/report_ads_phase9_representative_batch.py` | `AUTO-003`, `AUTO-005`, `MODEL-002`, `RET-001`, `CLS-001`, `VER-003`, `SCAE-001` | Print ADS Phase 9 representative clone-batch status from per-case real-runtime reports, including clone-only metadata, classifications, blocked-write safety, handoff/drain health, and retry bounds. |
| `/Users/agent2/.openclaw/orchestrator/scripts/predquant/ads_phase9_representative_batch.py` | `AUTO-003`, `AUTO-005`, `MODEL-002`, `RET-001`, `CLS-001`, `VER-003`, `SCAE-001` | Importable ADS Phase 9 representative clone-batch classifier and pass/fail report builder. |
...
| `/Users/agent2/.openclaw/orchestrator/scripts/predquant/training_trace.py` | `FND-007`, `TRACE-001`, `TRACE-002`, `MIG-009` | Importable minimal training trace pointer builder, validator, Session 5 role-ref adapter, full trace materialization contract, and persistence helper; records replayable artifact pointers and hashes without live forecast authority. |
| `/Users/agent2/.openclaw/orchestrator/scripts/predquant/model_provenance_trace.py` | `MODEL-004`, `MIG-009` | Importable decomposer/researcher model provenance trace helper for minimal traces, recording lane/model/policy/prompt/schema/artifact hashes without live forecast authority. |
| `/Users/agent2/.openclaw/orchestrator/scripts/predquant/calibration_debt.py` | `CAL-001`, `MIG-010` | Importable non-authoritative calibration-debt clearance report over SCORE-001 Brier/scorecard evidence, trace completeness, tail/regime diagnostics, protected component diagnostics, and pointer stability evidence. |
| `/Users/agent2/.openclaw/orchestrator/scripts/predquant/calibration_maturity.py` | `TRACE-002`, `CAL-002`, `CAL-003`, `CAL-004`, `CAL-005`, `MIG-011` | Importable Session 6 maturity helpers for lane registry, candidate bounds, component diagnostics, canary/promotion/rollback, retrieval/profile/actionability candidates, emergency conservative overlays, temporal reuse safety, and optimization maturity results without live forecast authority. |
| `/Users/agent2/.openclaw/orchestrator/scripts/migrations/011_calibration_tuning_records.sql` | `CAL-002`, `CAL-003`, `CAL-004`, `CAL-005`, `MIG-011` | Named Session 6 migration for calibration candidates, diagnostics, lane health, canary state, active pointers, rollback events, policy snapshots, emergency overlays, and maturity results. |
...
| `/Users/agent2/.openclaw/researcher-swarm/scripts/migrations/004_retrieval_evidence_persistence.sql` | `MIG-004` | Named Session 3 persistence migration for retrieval packet refs, admitted evidence, chunks, browser/native/provider diagnostics, source metadata, claims, breadth, missingness, fallback, expansion, and sufficiency certificate surfaces. |
| `/Users/agent2/.openclaw/researcher-swarm/scripts/migrations/006_researcher_verification_persistence.sql` | `MIG-006` | Named Session 4 persistence migration for researcher prompt refs, assignments, isolation, classification/provenance, coverage, escalation, verification, readiness refs, and sufficiency reconciliation surfaces. |
...
| `/Users/agent2/.openclaw/researcher-swarm/scripts/researcher_swarm/model_preflight.py` | `RET-007` | Importable report-only local embedding/reranker preflight contract with resource caps and pass/unavailable/block diagnostics; no downloads, long-running model tasks, or global model-default changes. |
...
| `/Users/agent2/.openclaw/researcher-swarm/scripts/researcher_swarm/escalation.py` | `CLS-007` | Importable adaptive escalation policy, caps, pre-SCAE leverage proxy, decision artifact validation, and linked extra assignment descriptor/packet planning without live spawning. |
...
| `/Users/agent2/.openclaw/researcher-swarm/scripts/researcher_swarm/persistence.py` | `MIG-004`, `MIG-006`, `RET-001` to `RET-011`, `CLS-001` to `CLS-008`, `VER-001` to `VER-004`, `MODEL-003` | Importable compact/ref-only Session 3 retrieval persistence and Session 4 researcher/verification persistence helpers without probability, forecast, SCAE ledger, or decision authority. |
...
| `/Users/agent2/.openclaw/SCAE/scripts/scae/missingness.py` | `SCAE-008` | Temporal missingness and survival/no-catalyst candidate diagnostics with explicit mechanism-proof, hazard-family, source-coverage, unpriced-interval, and overlap guards, without ledger or forecast authority. |
