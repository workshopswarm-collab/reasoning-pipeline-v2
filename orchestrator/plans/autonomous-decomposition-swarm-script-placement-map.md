...
| `/Users/agent2/.openclaw/orchestrator/scripts/predquant/training_trace.py` | `FND-007`, `TRACE-001`, `MIG-009` | Importable minimal training trace pointer builder, validator, Session 5 role-ref adapter, and persistence helper; records replayable artifact pointers and hashes without live forecast authority. |
